...
public class Vector2D 
{
	 ...
	 * @return Itself
	 * 
	 * @see de.jcm.math.Vector2D#add(double, double)
	 * 
	 * @author JCM
	 ...
	 * @return Itself
	 * 
	 * @see de.jcm.math.Vector2D#add(Vector2D)
	 * 
	 * @author JCM
	 ...
	 * @return Itself
	 * 
	 * @see de.jcm.math.Vector2D#remove(double, double)
	 * 
	 * @author JCM
	 * @since 22.11.2016 19:34
	 */
	public Vector2D remove(Vector2D v2d)
	{
		this.x=this.x-v2d.x;
		this.y=this.y-v2d.y;
		return this;
	 ...
	 * @return Itself
	 * 
	 * @see de.jcm.math.Vector2D#remove(Vector2D)
	 * 
	 * @author JCM
	 * @since 22.11.2016 19:30
	 */
	public Vector2D remove(double x,double y)
	{
		this.x=this.x-x;
		this.y=this.y-y;
		return this;
